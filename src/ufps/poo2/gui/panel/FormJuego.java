...
public class FormJuego extends javax.swing.JFrame {
    ...
    public FormJuego(int tam, FormSala s) {
        ...
        mostrarPuntos();
        sala = s;
        labels[0]=lblJugador1;
        labels[1]=lblPunto1;
        labels[2]=lblJugador2;
        labels[3]=lblPunto2;
        labels[4]=lblJugador3;
        labels[5]=lblPunto3;
        labels[6]=lblJugador4;
        labels[7]=lblPunto4;
...
if (panelActivos == null) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtMensaje.getText().length() > 1200) {
            JOptionPane.showMessageDialog(this, "El tamaño del mensaje excede el límite permitido de 1200 caracteres", "Alerta", JOptionPane.WARNING_MESSAGE);
            return;
        }else if(txtMensaje.getText().trim().length() == 0){
            return;
        }
    ...
    private void txtMensajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtMensajeActionPerformed
        if (txtMensaje.getText().length() > 1200) {
            JOptionPane.showInternalConfirmDialog(this, "El tamaño del mensaje excede el límite permitido de 1200 caracteres", "Alerta", JOptionPane.WARNING_MESSAGE);
            return;
        }else if(txtMensaje.getText().trim().length() == 0){
            return;
        }
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                if (controlador.guardarChat(guardar, this.txtArea.getText())) {
                    JOptionPane.showMessageDialog(null, "Chat guardado", "Notificación", JOptionPane.INFORMATION_MESSAGE);
                }
            ...
            public void run(){
                while(partidoActivo){
                    ...
                    for (int i = 0; i < puntos.length; i+=2) {
                        labels[i].setText(puntos[i]);
                        labels[i+1].setText(puntos[i+1]);
                    }
                }
            }
        });
    ...
    public void validarGanador() {
        Thread Hilo = new Thread(new Runnable() {
            public void run() {
                ...
                if (ganador != "") {
                    JOptionPane.showMessageDialog(null, ganador, "Notificación", JOptionPane.INFORMATION_MESSAGE);
